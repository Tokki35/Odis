...
<div style="margin-top: 120px;">
  ...
  <div style="margin-top: 30px;float:left;margin-left:1%;width:70%">
    <p style="margin-left:95px;font-size:1.3em;"><u><b>Recommandation:</b></u> Pour faire durer davantage votre voiture prenez vous devez respecter les différents étapes d’entretien de votre véhicule, effectuer des lavages réguliers de votre carrosserie, vidanger l’huile, remplacer les filtres, vérifier les bougies et surtout ne négliger pas les éléments situés en dessous du véhicule telle la suspension. 
     </p>
  </div>
</div><!-- /.container -->
