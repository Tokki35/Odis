...
<?php $cheminImg = "../inc/img/Industrie/PROTECTION/"; ?>
...
<div id="content" style="margin-top: 120px;">
  <div id="paragraphe" style="margin-top: 30px;float:left;width:70%">
    <h1 style="color:rgb(0,176,80)"><img src="../inc/img/puce-H1-2.png" />Protection - Hygiène - Sécurité</h1><br />
    <p style="margin-left:95px;font-size:1.3em;">Pour tous vos travaux, la protection individuelle de votre équipe et de vous-même est un aspect incontournable. <br />
    ODIS a donc sélectionné pour vous une gamme de produits qui vous garantie une protection optimale.</p>
  </div>
  <div style="margin-top: 20px;float:left;">    
    <a target="_blank" href="../inc/files/industrie/protection/PROTECTION-tete.pdf"><img style="margin-left: 25px;" src="<?php echo $cheminImg; ?>protection de la tête.png" /></a>
    <a target="_blank" href="../inc/files/industrie/protection/PROTECTION-yeux.pdf"><img style="margin-left: 25px;" src="<?php echo $cheminImg; ?>protection des yeux.png" /></a>
    <a target="_blank" href="../inc/files/industrie/protection/PROTECTION-auditive.pdf"><img style="margin-left: 25px;" src="<?php echo $cheminImg; ?>protection des oreilles.png" /></a>
    <a target="_blank" href="../inc/files/industrie/protection/PROTECTION-respiratoire.pdf"><img style="margin-left: 25px;" src="<?php echo $cheminImg; ?>protection respiratoire.png" /></a>
    <a target="_blank" href="../inc/files/industrie/protection/PROTECTION-mains.pdf"><img style="margin-left: 25px;" src="<?php echo $cheminImg; ?>protection des mains.png" /></a> 
  </div>
  <div style="margin-top: 30px;float:left;">
    <a target="_blank" href="../inc/files/industrie/protection/PROTECTION-vetements.pdf"><img style="margin-left: 25px;" src="<?php echo $cheminImg; ?>vêtements de protection.png" /></a>
    <a target="_blank" href="../inc/files/industrie/protection/PROTECTION-peids.pdf"><img style="margin-left: 25px;" src="<?php echo $cheminImg; ?>protection des pieds.png" /></a>
    <a target="_blank" href="../inc/files/industrie/protection/PROTECTION-hygiene.pdf"><img style="margin-left: 25px;" src="<?php echo $cheminImg; ?>hygiène.png" /></a>
    <a target="_blank" href="../inc/files/industrie/protection/PROTECTION-secours.pdf"><img style="margin-left: 25px;" src="<?php echo $cheminImg; ?>1er secours.png" /></a>
    <a target="_blank" href="../inc/files/industrie/protection/PROTECTION-hauteur.pdf"><img style="margin-left: 25px;" src="<?php echo $cheminImg; ?>travail en hauteur.png" /></a>
  </div>
  <div id="conseilOdis" style="margin-top: 100px;float:left;width:70%;">
    ...
    Les VGP (Vérifications Générales Périodiques) des EPI doivent se faire conformément à la notice d’instructions rédigée par le fabricant, systématiquement livrée par ce dernier avec chaque EPI. 
    </p>
  </div> 
...
$(function () {
  ...
  document.getElementById("Protection - Hygiène Sécurité").style.backgroundColor = 'rgba(0, 204, 102, 0.5)';
