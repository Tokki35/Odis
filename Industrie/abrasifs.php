...
<!-- Contenu -->
<?php $cheminImg = "../inc/img/Industrie/ABRASIFS/"; ?>
...
<div id="content" style="margin-top: 120px;">
  <div id="paragraphe" style="margin-top: 30px;float:left;width:70%">
    <h1 style="color:rgb(0,176,80)"><img src="../inc/img/puce-H1-2.png" />Abrasifs et outils coupants</h1><br />
    <p style="margin-left:95px;font-size:1.3em;">Le groupe ODIS s’associe avec des marques reconnues afin de vous garantir des produits possédant<br />
     les meilleures technologies et qui  nous permet de vous garantir une haute qualité d’abrasifs et d’outils coupants.
</p>
  </div>
  <div style="margin-top: 20px;float:left;>
    <img style="margin-left: 25px;" src="<?php echo $cheminImg; ?>trepans.png" />
    <img style="margin-left: 25px;" src="<?php echo $cheminImg; ?>lames de scie.png" />
    <img style="margin-left: 25px;" src="<?php echo $cheminImg; ?>forets.png" />
    <img style="margin-left: 25px;" src="<?php echo $cheminImg; ?>burins.png" />
    <img style="margin-left: 25px;" src="<?php echo $cheminImg; ?>meches.png" />
  </div>
  <div style="margin-top: 30px;float:left;>
    <img style="margin-left: 25px;" src="<?php echo $cheminImg; ?>tarauds.png" />
    <img style="margin-left: 25px;" src="<?php echo $cheminImg; ?>fraises.png" />
    <img style="margin-left: 25px;" src="<?php echo $cheminImg; ?>rouleaux d'atelier.png" />
    <img style="margin-left: 25px;" src="<?php echo $cheminImg; ?>disques de ponçage.png" />
  </div>
   <div style="margin-top: 30px;float:left;>
   <img style="margin-left: 25px;" src="<?php echo $cheminImg; ?>disques abrasifs.png" />
    ...
    <img style="margin-left: 25px;" src="<?php echo $cheminImg; ?>brosses abrasives.png" />
    <img style="margin-left: 25px;" src="<?php echo $cheminImg; ?>meules de tronçonnage.png" />
    <img style="margin-left: 25px;" src="<?php echo $cheminImg; ?>disques de tronçonnage.png" />
  </div>
  <div style="margin-top: 100px;float:left;width:70%;">
    ...
    Dans le choix de votre papier abrasif, les étapes de ponçage vont déterminer le grain de votre abrasif : moins de 50 grains : enlèvement de matière de 50 à 80 grains : décapage, dégrossissage, première passe de ponçage de 80 à 120 grains : ponçage, 120 et plus : Finition plus ou moins poussée.
    </p>
  </div>  

  <div id="conseilOdis" style="display:inline;float:left;margin-left:30px;width:1000px;font-size:1.1em;">
...
$(function () {
  ...
  document.getElementById("Abrasifs").style.backgroundColor = 'rgba(0, 204, 102, 0.5)';
