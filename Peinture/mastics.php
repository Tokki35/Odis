...
<div style="margin-top: 120px;">
  ...
  <div style="margin-top: 30px;float:left;margin-left:1%;width:70%">
    <p style="margin-left:95px;font-size:1.3em;"><u><b>Recommandation:</b></u> Pensez à distinguer les différents types de matériels adéquates à vos travaux. Les colles de contact par exemple sont destinées à des supports poreux tandis que les colles réactives sont adaptés à des supports lisses. 
    </p>
  </div>
