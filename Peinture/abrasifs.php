...
<div style="margin-top: 120px;">
  ...
  <div style="margin-top: 30px;float:left;margin-left:1%;width:70%">
    <p style="margin-left:95px;font-size:1.3em;"><u><b>Recommandation:</b></u> Nombreux sont ceux qui ne respecte pas l’étape du ponçage. Or, c’est une étape essentielle pour que la couche adhère au mieux, il ne faut pas oublier que la préparation du support conditionnera le résultat. 
