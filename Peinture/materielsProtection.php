...
<div style="margin-top: 120px;">
  ...
  <div style="margin-top: 30px;float:left;margin-left:1%;width:70%">
    <p style="margin-left:95px;font-size:1.3em;"><u><b>Recommandation:</b></u> Peintres professionnels ou amateurs il est important de porter des gants même si cela peut vous sembler gênant voir inutile.   
    </p>
  </div>
