...
<!-- Contenu -->
<div class="container" style="margin-top: 120px"> <!-- style="margin-top: 120px;" -->
  ...
  <div style="width:50%;display:inline;float:left;font-size:1.1em;">
      ...
      Spécialiste de la négoce avec une équipe technique de 153 personnes à votre service, pour vous accueillir et vous conseiller, que vous soyez professionnels ou particuliers.<br /><br />
